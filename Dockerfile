...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:24@sha256:bd52f182c9f973b6419ca10060671a509519dd66ea5601fa0f0c709acef15725 AS runtime
WORKDIR /app
